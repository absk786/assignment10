...
function employeeByManager(db, runApp) {
...
function removeEmployee(db, runApp, answers) {
    console.log("Remove employee")
    const sql = `DELECTE * FROM employees WHERE id=?;`
    db.query(sql, answers, (err, result) => {
        if (err) {
            console.log(err)
        }
...
function updateEmployeeManager(db, runApp, answers) {
